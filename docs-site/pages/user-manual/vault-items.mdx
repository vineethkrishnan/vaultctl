...
**Duplicate** -- In the web vault, open an item row's three-dot menu and select **Duplicate item** to create a copy and jump straight into editing it. The copy's name gets a "[Copy]" suffix, and its folder, favorite, and reprompt settings carry over. Attachments are not copied; if the item has any, vaultctl asks you to confirm before duplicating.
