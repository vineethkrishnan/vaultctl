...
- **Homebrew required:** on macOS the installer uses Homebrew to install a headless runtime (`colima` + the `docker` CLI). Install [Homebrew](https://brew.sh) first, then re-run.
