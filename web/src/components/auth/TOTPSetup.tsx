...
export function TOTPSetup({ onComplete, onCancel }: Props) {
  ...
  async function handleSetup() {
    ...
    try {
      ...
      // Enabling 2FA requires a recent master-password proof; on that 403 open
      // the step-up modal and retry the setup once it succeeds, rather than
      // dead-ending on the raw error.
